...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Register & Login System | Muaz Internship XM 2015';
$config['webmaster_email'] = 'muaz@muaz.xyz';
...
$config['recaptcha_public_key'] = '6LdRdg0TAAAAAChg47jfSn4NhTaM9aONE8p5nTVj';
$config['recaptcha_private_key'] = '6LdRdg0TAAAAAJXxIK2QDv99Bf2Cw0Ju026ZodYI';
